...
Zur Realisierung des Clients wird auf die etwas komfortablere Skriptsprache CoffeeScript
zurückgegriffen. CoffeeScript-Code ist gegenüber \acr{js}-Code deutlich kürzer, (Etwa 30\%) und hat
...
Fließtext-Elementen geht. Da in dieser Anwendung jedoch nur wenige Elemente klassischer Seiten zum
...
Syntax-Highlighting, welches sich in einem Prototyp relativ leicht an das Serverseitige
Syntax-Highlighting anbinden ließ. \acr{ace} bietet alle Funktionen, welche man von einem Modernen
...
leidet die Performanz. Da wir jedoch darauf angewiesen sind, müssen wie diese Einbußen in der
...
Fenster die Information über das Kommando unter dem Cursor visualisiert. Diese Lösung übernehmen
...
Beweiszustände zu integrieren. Das ist vor allem für das Verständnis der Zusammenhänge hilfreich. Da
...
Das stellt sich als schwierige Herausforderung dar. Insbesondere müssen der Inhalt des Texteditors
...
weiteren Tastendrucks innerhalb der Zeitspanne, wird das Timeout neu gestartet (\textit{Reset}) so
